  ...
  return (
    <div>
      <div className="about">
        ...
        <h3>Values:</h3>
        <p>Innovation: We thrive on creativity and embrace new ideas.</p>
        <p>Integrity: We uphold honesty, transparency, and ethical conduct.</p>
        <p>Teamwork: Together, we achieve more than we can individually.</p>
      </div>
