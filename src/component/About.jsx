  ...
  return (
    <div>
      <div className="about">
        ...
        <p>
          {" "}
          <strong>Innovation</strong>: We thrive on creativity and embrace new
          ideas.
        </p>
        <p>
          {" "}
        ...
        <p>
          {" "}
          <strong>Teamwork</strong>: Together, we achieve more than we can
          individually.
        </p>
      </div>
      ...
      <div className="container">
        <div className="column">
          ...
          <p>
            {" "}
            <strong>Email: </strong> dieegoolimaa@gmail.com
          </p>
          <p>
            {" "}
          ...
          <p>
            {" "}
            <strong>Github: </strong> https://github.com/dieegoolimaa
          </p>
        ...
        <div className="column">
          ...
          <p>
            {" "}
            <strong> Role:</strong> FrontEnd Dev
          </p>
          <p>
            {" "}
            <strong>Email: </strong> MrGandomaestro@outlook.com
          </p>
          <p>
            {" "}
            <strong> LinkedIn: </strong>{" "}
            www.linkedin.com/in/celso-gando-301b072b1
          </p>
          <p>
            {" "}
            <strong> GitHub: </strong> https://github.com/TheOne-1-dot
          </p>
        ...
        <div className="column">
          ...
          <p>
            {" "}
            <strong>Email: </strong> rui.folgado@hotmail.com
          </p>
          <p>
            {" "}
            <strong>LinkedIn: </strong> #
          ...
          <p>
            {" "}
            <strong>GitHub: </strong> https://github.com/Folgad0
          </p>
